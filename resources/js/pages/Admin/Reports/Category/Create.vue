<script setup lang="ts">
    ...
    import { store as categoryStore } from '@/routes/admin/reports/categories'

    function goBack() { history.back() }
</script>

<template>
    <Form :action="categoryStore()">
        <template #default="{ errors, processing }">
            <AppFormLayout title="New Report Category">
                <AppInput name="name" label="Name" :error="errors.name" placeholder="e.g. Market Research" required />
