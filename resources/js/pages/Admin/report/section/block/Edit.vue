<script setup lang="ts">
    ...
    const form = useForm({
        type: props.block.type.value,
        title: props.block.title ?? '',
        description: props.block.description ?? '',
        content: props.block.content
            ? JSON.stringify(props.block.content, null, 4)
            : '',
...
<template>
    ...
    <Head :title="`Edit Content Block - ${section.title}`" />
    ...
    <TableLayout>
        <div class="space-y-6">
            <div class="flex items-center gap-3">
                ...
                <Heading title="Edit Content Block" :description="`${report.title} / ${section.title}`" />
            </div>
