...
import { index as manageTaxonomy } from '@/routes/admin/interviews/taxonomy'
...
function getInterviewActions(interview: Interview): TableAction[] {
    return [
        ...
        },
        {
            ...
            icon: Pencil,
            href: manageTaxonomy(interview.id).url,
        },
        {
        ...
        <template #header>
            ...
            >
                <div>
                    ...
                    <AppText>
                        Manage and organize your interviews.
                    </AppText>
                </div>
        ...
        >
            —
                ...
                <template #cell-actions="{ row }">
                    <AppTableActions
                        :actions="getInterviewActions(row)"
                    />
                </template>
            </AppTable>
        </div>
